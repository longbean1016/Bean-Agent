...
class Provider:
    ...
    async def complete(self, messages, tools=None, **kwargs):
        ...
        return SimpleNamespace(content='{"active_topics":["记忆模块"],"user_preferences":[],"follow_ups":["继续测试"],"avoidances":[],"dormant_threads":["旧流式方案讨论","旧语音输入讨论","旧代码高亮讨论","旧刷新恢复讨论","旧提醒确认讨论","第六条应丢弃"],"ongoing_threads":[]}')
